...
def show_main_menu():
    ...
    tk.Label(root, text=f"Selamat Datang, {current_user['username']}", font=("Arial", 18)).pack(pady=10)
    tk.Button(root, text="Tambah Transaksi", command=add_transaction).pack(pady=5)
    tk.Button(root, text="Lihat Laporan", command=show_report).pack(pady=5)
...
def show_home():
    ...
    tk.Label(root, text="Aplikasi Pengelolaan Uang", font=("Arial", 24)).pack(pady=20)
...
def sign_in():
    ...
    clear_frame()
    tk.Label(root, text="Sign In", font=("Arial", 18)).pack(pady=10)
    ...
    tk.Button(root, text="Sign In", command=submit_signin).pack(pady=10)
    tk.Button(root, text="Kembali", command=show_home).pack(pady=10)
...
def sign_up():
    ...
    tk.Button(root, text="Sign Up", command=submit_signup).pack(pady=10)
    tk.Button(root, text="Kembali", command=show_home).pack(pady=10)
